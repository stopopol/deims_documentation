...
In order to add a site you have to log in.
When adding a dataset please bear in mind that you can reuse already defined geographic boundaries.
...
If you have multiple datasets that all share the same geographic extend you can create the observation location once and reference all datasets to thisobservation location.
