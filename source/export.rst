...
DEIMS offers multiple ways of programmatically extracting information that always reflects the latest version of information in the DEIMS database.

REST-API
============================================================
DEIMS has a REST-API (https://deims.org/api) following the Open API 3.0 specification.
...
* https://deims.org/api/sites (returns the list of all sites on DEIMS as .json)
* https://deims.org/api/activities (returns the list of all activities on DEIMS as .json)
* https://deims.org/api/sensors (returns the list of all sensors on DEIMS as .json)
...
These lists always include the title, the unique ID used in DEIMS, coordinates and change date of a site.
...
WMS/WFS
============================================================
DEIMS provide WMS/WFS services for site records.
...
* https://deims.org/geoserver/deims/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=deims:deims_all_sites&outputFormat=shape-zip (all site records on DEIMS as Shapefile)
* https://deims.org/geoserver/deims/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=deims:deims_all_sites&outputFormat=kml (all ILTER sites on DEIMS as KML)
...
CSW/OAI-PMH
============================================================
DEIMS provides site records as ISO19139 served by OGC-CSW and OAI-PMH.
...
Python
============================================================
DEIMS also has a Python package that eases data access. You can find more information here: https://pypi.org/project/deims/
